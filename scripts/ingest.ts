 ...
 * See the UK implementation (uk-land-woodland-mcp) for the reference pattern.
 *
...
console.log('See uk-land-woodland-mcp/scripts/ingest.ts for the reference pattern.');
